...
<template>
  <AppLayout :breadcrumbs="breadcrumbs">
    <Head title="Página de ingredientes" />
    <template #header>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          >
            ...
            <div class="p-4">
              ...
              <div class="flex space-x-2">
                ...
                <div v-if="canEdit(receita) && page.props.auth.user.tipo_usuario === 'admin'" class="flex space-x-1">
                  <Link
        ...
        <!-- Pagination -->
        <div v-if="ingrediente.links.length > 3" class="flex justify-center" data-aos="fade-up">
          <nav class="flex items-center space-x-1">
            <Link
              v-for="link in ingrediente.links"
              :key="link.label"
              :href="link.url ?? ''"
              :class="[
        ...
        <!-- Empty State -->
        <div
          v-if="ingrediente.data.length === 0"
        ...
        <div class="mt-3 text-center">
          ...
          <div class="mt-2 px-7 py-3">
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Tem certeza que deseja excluir o ingrediente "{{ ingredienteToDelete?.nome }}"?
...
import type { Receita, Ingrediente, Categoria, PageProps, BreadcrumbItem} from '@/types'
...
const ingredienteToDelete = ref<Receita | null>(null)
...
const confirmDelete = (receita: Receita) => {
  ingredienteToDelete.value = receita
  showDeleteModal.value = true
}

const deleteReceita = () => {
  if (ingredienteToDelete.value) {
    router.delete(route('receitas.destroy', ingredienteToDelete.value.id), {
      onSuccess: () => {
